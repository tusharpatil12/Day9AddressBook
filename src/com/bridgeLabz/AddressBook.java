...
public class AddressBook {
	...
	static PersonContact cp = new PersonContact();
	...
	public void displayContact(PersonContact cp) {
		System.out.println(cp);

	}

	public void editContact(PersonContact cp) {
		int choice = 0;
	...
	public void deleteContact(PersonContact cp) {
